...
import { hasHover as _hasHover, hasMouse as _hasMouse } from '../../lib/inputUtils';
import { AdaptivityContext, AdaptivityProps, SizeType, ViewHeight, ViewWidth } from './AdaptivityContext';
...
const AdaptivityProvider: React.FC<AdaptivityProps> = (props) => {
  const adaptivityRef = React.useRef<ReturnType<
    typeof calculateAdaptivity> | null
    >(null);
...
function calculateAdaptivity(
  ...
  if (viewHeight >= MEDIUM_HEIGHT) {
    viewHeight = ViewHeight.MEDIUM;
  } else if (viewHeight > MOBILE_LANDSCAPE_HEIGHT) {
