...
import { coordX, coordY, getSupportedEvents, touchEnabled, TXUITouchEvent } from '../../lib/touch';
...
export const Touch: React.FC<TouchProps> = ({
  ...
  function onMove(e: TXUITouchEvent) {
    const {
      isPressed,
      isX,
      isY,
  ...
  function onEnd(e: TXUITouchEvent) {
